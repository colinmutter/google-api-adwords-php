...
class LogicalUserList extends UserList {
  ...
  public function __construct($rules = NULL, $id = NULL, $isReadOnly = NULL, $name = NULL, $description = NULL, $status = NULL, $accessReason = NULL, $accountUserListStatus = NULL, $membershipLifeSpan = NULL, $size = NULL, $sizeRange = NULL, $type = NULL, $UserListType = NULL) {
    parent::__construct();
    $this->rules = $rules;
    $this->id = $id;
    $this->isReadOnly = $isReadOnly;
...
class UserListService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201209/UserListService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'UserListService', 'https://adwords.google.com/api/adwords/cm/v201209');
  }
  ...
  public function get($serviceSelector) {
    $arg = new UserListServiceGet($serviceSelector);
