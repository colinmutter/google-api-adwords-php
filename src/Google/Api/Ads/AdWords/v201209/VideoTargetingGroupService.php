...
class ServingIssue {
  ...
  public function __construct($reason = NULL, $campaignId = NULL, $targetingGroupId = NULL, $hideActionLink = NULL) {
    $this->reason = $reason;
...
class VideoTargetingGroupService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/video/v201209/VideoTargetingGroupService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'VideoTargetingGroupService', 'https://adwords.google.com/api/adwords/video/v201209');
  }
