...
class ManagedCustomerServiceError extends ApiError {
   ...
   */
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/mcm/v201209";
  }
...
class ManagedCustomerLink {
  ...
  public function __construct($managerCustomerId = NULL, $clientCustomerId = NULL) {
...
class ManagedCustomer {
  ...
  public function __construct($name = NULL, $login = NULL, $companyName = NULL, $customerId = NULL, $canManageClients = NULL, $currencyCode = NULL, $dateTimeZone = NULL) {
    $this->name = $name;
    $this->login = $login;
...
class ManagedCustomerService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201209/ManagedCustomerService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ManagedCustomerService', 'https://adwords.google.com/api/adwords/mcm/v201209');
  }
