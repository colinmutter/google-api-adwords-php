...
class ExperimentService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201209/ExperimentService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ExperimentService', 'https://adwords.google.com/api/adwords/cm/v201209');
  }
