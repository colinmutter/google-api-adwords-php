...
/**
 * GoogleKeyword represents a keyword to be used for targeting google
 * search network exclusively.
 *
 * Note that this is a specialization of Keyword, except that it has different
 * scopes, returned only when explicitly asking for GOOGLE_KEYWORD type.
 * @package GoogleApiAdsAdWords
 * @subpackage awfv
 */
...
class VideoTargetingGroupCriterionService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/video/v201209/VideoTargetingGroupCriterionService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'VideoTargetingGroupCriterionService', 'https://adwords.google.com/api/adwords/video/v201209');
  }
