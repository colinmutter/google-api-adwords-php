...
class BiddingStrategyConfiguration {
  ...
  public function __construct($biddingStrategyType = NULL, $biddingScheme = NULL, $bids = NULL) {
...
class RichMediaAd extends Ad {
  ...
  public function __construct($name = NULL, $dimensions = NULL, $snippet = NULL, $impressionBeaconUrl = NULL, $adDuration = NULL, $certifiedVendorFormatId = NULL, $sourceUrl = NULL, $richMediaAdType = NULL, $id = NULL, $url = NULL, $displayUrl = NULL, $devicePreference = NULL, $disapprovalReasons = NULL, $AdType = NULL) {
    parent::__construct();
    $this->name = $name;
    $this->dimensions = $dimensions;
...
class MutateJobService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201302/MutateJobService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'MutateJobService', 'https://adwords.google.com/api/adwords/cm/v201302');
  }
