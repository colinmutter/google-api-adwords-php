...
class AdFormatSpec {
   ...
   */
  public function getNamespace() {
    return "https://adwords.google.com/api/adwords/o/v201302";
  }
 ...
 * <p>
 * Starting from v201302, we will only allow one language being targeted if
 * IdeaType is KEYWORD.
...
class TargetingIdeaService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/o/v201302/TargetingIdeaService";
