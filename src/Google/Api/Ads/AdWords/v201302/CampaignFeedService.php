...
/**
 * CampaignFeeds are used to link a feed to an campaign using a matching function,
 ...
 * resulting in a return value. The type of the return value depends on the
 * operator being applied and the type of the operands.
 *
...
/**
 * Operation used to create or mutate an CampaignFeed.
 * @package GoogleApiAdsAdWords
 * @subpackage v201302
 */
...
class CampaignFeedService extends AdWordsSoapClient {
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CampaignFeedService', 'https://adwords.google.com/api/adwords/cm/v201302');
  }
