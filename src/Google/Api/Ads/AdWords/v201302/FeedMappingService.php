...
/**
 * A FeedMapping represents a mapping between feed attributes in a specific feed and placeholder
 * fields for a specific placeholder type. This will tell the ads serving system what parts of the
 * feed item should be used when populating a placeholder. Without this mapping the placeholder
 * cannot be populated and the extension can not be displayed.
 * @package GoogleApiAdsAdWords
 * @subpackage v201302
 */
class FeedMapping {
...
class FeedMappingService extends AdWordsSoapClient {
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'FeedMappingService', 'https://adwords.google.com/api/adwords/cm/v201302');
  }
