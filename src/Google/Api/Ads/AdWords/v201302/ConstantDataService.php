...
class ConstantDataService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201302/ConstantDataService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ConstantDataService', 'https://adwords.google.com/api/adwords/cm/v201302');
  }
