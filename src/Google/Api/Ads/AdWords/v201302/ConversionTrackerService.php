...
class AppConversion extends ConversionTracker {
  ...
  public function __construct($appId = NULL, $appPlatform = NULL, $userRevenueValue = NULL, $snippet = NULL, $appConversionType = NULL, $id = NULL, $name = NULL, $status = NULL, $category = NULL, $stats = NULL, $viewthroughLookbackWindow = NULL, $viewthroughConversionDeDupSearch = NULL, $isProductAdsChargeable = NULL, $productAdsChargeableConversionWindow = NULL, $ConversionTrackerType = NULL) {
    parent::__construct();
    $this->appId = $appId;
...
class ConversionTrackerService extends AdWordsSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201302/ConversionTrackerService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ConversionTrackerService', 'https://adwords.google.com/api/adwords/cm/v201302');
  }
