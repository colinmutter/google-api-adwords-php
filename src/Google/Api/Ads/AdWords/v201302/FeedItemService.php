...
class FeedItem {
  ...
  public function __construct($feedId = NULL, $feedItemId = NULL, $status = NULL, $startTime = NULL, $endTime = NULL, $attributeValues = NULL, $validationDetails = NULL, $devicePreference = NULL) {
    $this->feedId = $feedId;
...
class FeedItemService extends AdWordsSoapClient {
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'FeedItemService', 'https://adwords.google.com/api/adwords/cm/v201302');
  }
